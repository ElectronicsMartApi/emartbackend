...
const {view_all_products, view_by_name, view_by_category, view_by_price,view_by_rating,view_by_name_category,
...
const {VIEW_ALL_PRODUCTS,VIEW_BY_NAME,VIEW_BY_CATEGORY,VIEW_BY_PRICE,VIEW_BY_RATING,VIEW_BY_NAME_CATEGORY,
    VIEW_BY_NAME_CATEGORIES,VIEW_BY_CATEGORIES,SEARCH_IN_REVIEWS,VIEW_ALL_REVIEWS,VIEW_BY_PRODUCT_ID,
...
router.get(VIEW_BY_PRODUCT_ID,view_by_product_id);
